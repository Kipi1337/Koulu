...
bool TheApp::OnCreate()
{
	...
	m_uVertexShader = GetOpenGLRenderer()->CreateVertexShaderFromFile("simpleshader.vert");
	m_uFragmentShader = GetOpenGLRenderer()->CreateFragmentShaderFromFile("simpleshader.frag");
	...
	for (int32_t i=0; i<count; i++)
	{
		...
		node->SetPos(glm::linearRand(-10.0f, 10.0f),
